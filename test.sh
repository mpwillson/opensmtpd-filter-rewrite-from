...
./filter-rewrite-from.awk address no-reply@example.com <test.msgs
cat >test.msgs << EOF
config|ready
...
./filter-rewrite-from.awk masquerade example.com <test.msgs
echo "-Masquerade: will rewrite-"
./filter-rewrite-from.awk masquerade other.com <test.msgs
rm test.msgs
